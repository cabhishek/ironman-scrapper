...
CREATE TABLE `races` (
  ...
  `high_temp` DECIMAL(5,2) NULL,
  `low_temp` DECIMAL(5,2) NULL,
  `dew_point` DECIMAL(5,2) NULL,
  `high_humidity` DECIMAL(5,2) NULL,
  `low_humidity` DECIMAL(5,2) NULL,
  `precipitation_inches` DECIMAL(5,2) NULL,
  `peak_wind_speed` DECIMAL(5,2) NULL,
  `cloud_cover` DECIMAL(5,2) NULL,
  `starting_elevation` DECIMAL(5,2) NULL,
  `max_elevation` DECIMAL(5,2) NULL,
  `gross_elevation_gain` DECIMAL(5,2) NULL,
  `water_temperature` DECIMAL(5,2) NULL,
