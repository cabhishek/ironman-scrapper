...
module.exports = function scrape(rawHtml, scraperName) {
  ...
  _.extend(scrapers, { with_time: withTransitionTime });
  _.extend(scrapers, { without_time: withoutTransitionTime });
  _.extend(scrapers, { with_single_time: withSingleTransitionTime });
  _.extend(scrapers, { marathon: marathon });
